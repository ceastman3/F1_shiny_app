...
paste(2023, "<b>Season Champion:</b>",
          "<br><b>Driver:</b>", drvr$full_name, 
          "<br><b>Constructor:</b>", drvr$constr_name, 
          "<br><b>Total points:</b>", drvr$total_points)
```
