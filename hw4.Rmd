  ...
  navbarPage(
    tabPanel("Overview",
      fluidRow(
        ...
        column(3, selectInput("season", "Select Season", unique(races$year), selected = "2023")),
        # column(6,
        #   conditionalPanel(
...
server = function(input, output) {
  ...
  #   result_df(results[results$year == input$season, ])
  # })
  ...
  output$season_standings = renderPlot({
    ...
    ggplot(season_results, aes(y=reorder(surname, +total_points), x=total_points, fill = forename)) +
